      ...
      try {
        ...
        if (data.success) {
          ...
          setFormData({
            ...
            results: p.results.length > 0 ? p.results : [{ label: '', value: '' }],
            size: p.size || 'normal',
  ...
  if (fetching) {
    return (
      <div className="w-full bg-white min-h-screen flex flex-col justify-center items-center">
          <p className="text-xl text-neutral-500">Loading portfolio...</p>
      </div>
    );
  }
    ...
    <div className="w-full bg-white min-h-screen flex flex-col">
      <section className="pb-20">
        <div className="max-w-[800px] mx-auto">
          ...
          <h1 className="text-3xl font-bold text-neutral-900 mb-8">Edit Portfolio</h1>
