    ...
    <div className="w-full">
      <div className="max-w-[1400px] mx-auto">
          <div className="flex justify-between items-center mb-12">
            ...
            <Link href="/dashboard/products/new" className="bg-brand-yellow text-neutral-900 px-6 py-3 rounded-full font-bold hover:bg-[--brand-yellow-hover] transition-colors inline-flex items-center gap-2">
              ...
              <table className="w-full text-left">
                <thead className="bg-neutral-50 border-b border-neutral-200">
                  <tr>
                    ...
                    <th className="px-6 py-4 font-semibold text-neutral-600">Action</th>
                ...
                <tbody className="divide-y divide-neutral-100">
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={4} className="px-6 py-8 text-center text-neutral-500">No products found. Add one to get started.</td>
                    </tr>
                  ) : (
                    products.map((product) => (
                      <tr key={product._id} className="hover:bg-neutral-50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-neutral-600">{product.type}</td>
                        <td className="px-6 py-4 text-neutral-600 uppercase text-xs font-bold">{product.actionType}</td>
